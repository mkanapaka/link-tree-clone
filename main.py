...
def index():
    ...
    return render_template("index.html", themes=THEMES, current_theme=current_theme, profile_picture=profile_picture, edit_mode=edit_mode, user_name=user_name, unique_id=unique_id)
